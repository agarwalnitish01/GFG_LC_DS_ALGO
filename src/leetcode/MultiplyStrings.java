...
class MultiplyStrings {
    ...
    private static ArrayList<Integer> addStrings(ArrayList<Integer> num1, ArrayList<Integer> num2) {
    ...
    static ArrayList<Integer> multiplyOneDigit(StringBuilder firstNumber, char secondNumberDigit, int numZeros) {
    ...
    public static void main(String[] args){
        ...
        System.out.println(multiply("2","13"));
    }
}
